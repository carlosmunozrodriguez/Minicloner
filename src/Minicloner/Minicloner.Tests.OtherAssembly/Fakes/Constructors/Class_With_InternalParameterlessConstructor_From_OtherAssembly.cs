...
namespace Minicloner.Tests.OtherAssembly.Fakes.Constructors
{
    public class Class_With_InternalParameterlessConstructor_From_OtherAssembly
    {
        ...
        public static Class_With_InternalParameterlessConstructor_From_OtherAssembly Create()
        {
            return new Class_With_InternalParameterlessConstructor_From_OtherAssembly();
        }
    }
}